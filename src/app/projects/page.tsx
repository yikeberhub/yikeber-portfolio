    ...
    <section className="relative bg-[#030712] min-h-screen pt-32 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="mt-6 text-4xl font-bold text-white sm:text-5xl">Projects</h1>
              ...
              <motion.button
                ...
                className={`flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium transition-all ${
                  isActive
                    ...
                    : "border border-white/10 bg-transparent text-gray-400 hover:border-[#7C3AED]/30 hover:text-white"
                }`}
              >
                <Icon size={14} />
                {cat.label}
...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-xl border border-white/5 bg-[#0B1120] transition-all hover:border-[#7C3AED]/30 hover:bg-[#111827]"
    >
      {/* Image */}
      <div className="relative aspect-video overflow-hidden">
        ...
        />
        {project.featured && (
          <div className="absolute top-3 left-3 rounded-full bg-[#7C3AED] px-3 py-1 text-[10px] font-semibold text-white">
            Featured
          </div>
        )}
      </div>
